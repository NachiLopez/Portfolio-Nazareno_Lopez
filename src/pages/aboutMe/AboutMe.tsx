  ...
  return (
    <MainContainer id="aboutMe">
      <FirstSection>
        ...
        <h3 className="desc_text" id="personalFocus">
        ...
        <h3 className="desc_text">
          ...
          pensar como voy a desarrollar el código, creando un plan el cual me permite ir aprendiendo a través de la prueba y error 
        ...
        <h3 className="desc_text">
          Disfruto trabajar para el front-end con <span>React</span>, para el back-end con <span>Node.js</span> y para la base de datos con <span>SQL</span>, desarrollando aplicaciones escalables con un enfoque en buenas prácticas y rendimiento.
        ...
        la gente pudieran competir y ganar créditos para mejorar su equipo. Entoces, sin entender mucho pero con pura determinación, logré 
        levantar mi propio servidor. No llegué a lanzarlo públicamente porque desconocía la necesidad de un hosting, pero esa 
        experiencia despertó en mí la necesidad de crear mis propios juegos.
        </h3>
        ...
        <h3 className="desc_text">
          ...
          lo que terminó forjando la metodología que hoy aplico y explico en <span onClick={() => document.getElementById("personalFocus")?.scrollIntoView({ behavior: "smooth" })} style={{ cursor: "pointer"}}>mi filosofía de trabajo</span>.
        </h3>
      </FirstSection>
    </MainContainer>
  );
